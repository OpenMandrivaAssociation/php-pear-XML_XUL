...
install -d %{buildroot}%{_datadir}/pear/%{_class}/%{_subclass}/Element

install %{_pearname}-%{version}/*.php %{buildroot}%{_datadir}/pear/%{_class}
install %{_pearname}-%{version}/%{_subclass}/*.php %{buildroot}%{_datadir}/pear/%{_class}/%{_subclass}
install %{_pearname}-%{version}/%{_subclass}/Element/*.php %{buildroot}%{_datadir}/pear/%{_class}/%{_subclass}/Element
